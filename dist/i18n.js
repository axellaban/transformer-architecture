...
export const metricas={
  ...
  cabezasIndice:'32 cabezas de indexación',
  ...
  expertosOriginal:'2048 unidades ocultas<small>cómputo denso · ReLU</small>',
  dimensiones:valor=>`${valor}<small>dimensiones por token</small>`,
  flujosModernos:'4 flujos<small>Single-Pass mHC</small>',
  flujosOriginal:'Add & Norm<small>un flujo residual · post-LayerNorm</small>',
  ...
  engram:'196 mil millones · 2 módulos<small>capas 1 y 14 · 24 tablas hash por módulo</small>',
